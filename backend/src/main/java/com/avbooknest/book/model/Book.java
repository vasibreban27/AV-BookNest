...
public class Book {
  ...
  private Book(Builder builder) {
    ...
    price = builder.price;
    bookCondition = builder.bookCondition;
  ...
  public void reserve() {
    if (status != BookStatus.AVAILABLE) {
      throw new IllegalStateException("Only available books can be reserved");
    }
  ...
  public static class Builder {
    ...
    public Builder bookCondition(BookCondition value) {
      bookCondition = value;
      return this;
    }
