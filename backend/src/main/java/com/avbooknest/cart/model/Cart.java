...
public class Cart {
    ...
    protected Cart() { }
    private Cart(Builder builder) { user = builder.user; createdAt = builder.createdAt; updatedAt = builder.updatedAt; }
    public Long getId() { return id; }
    public User getUser() { return user; }
    public Instant getCreatedAt() { return createdAt; }
    public Instant getUpdatedAt() { return updatedAt; }
    public List<CartItem> getItems() { return items; }
    public void addItem(CartItem item) { items.add(item); touch(); }
    public void removeItem(CartItem item) { items.remove(item); touch(); }
    public void clearItems() { items.clear(); touch(); }
    private void touch() { updatedAt = Instant.now(); }
    public static Builder builder() { return new Builder(); }
    public static class Builder {
        private User user; private Instant createdAt; private Instant updatedAt;
        public Builder user(User value) { user = value; return this; }
