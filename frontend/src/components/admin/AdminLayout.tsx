...
const adminNavigation = [
  ...
  { to: '/admin/reports', end: false, mark: 'RP', label: 'Raportări', description: 'Dovezi și sancțiuni' },
  { to: '/admin/support', end: false, mark: 'SP', label: 'Suport', description: 'Solicitări și conversații' },
...
const pageTitles: Record<string, string> = {
  ...
  '/admin/reports': 'Raportări de conținut',
